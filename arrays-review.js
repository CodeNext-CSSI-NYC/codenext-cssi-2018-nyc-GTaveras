...
// var array = ["shrimp", "lobster", "strawberry", "gummy bears"];
// for (var i = 0; i < array.length; i++) {
//   var current = array[i];
//   console.log(current);
//   var upper = array[i].toUpperCase();
//   console.log(upper);
// }
...
// var cities = ["Tokyo", "New York", "LA", "Paris", "London"];
...
// var sixNums = [1, 2, 3, 4, 5, 6]
// for (var i = 0; i < sixNums.length; i++) {
//   var num = sixNums[i];
//   sixNums[i] = (num ** 2);
// }
// console.log(sixNums);
...
// var sixNums = [1, 2, 3, 4, 5, 6];
// var reverse = [];
// for (var i = sixNums.length - 1; i >= 0; i--) {
//   var num = sixNums[i];
//   reverse.push(num);
// }
// console.log(sixNums);
...
// var reverse = [];
// var numOfLetters = parseInt(readline.question("How many letters would you like to type in: "));
// for (var i = 0; i < numOfLetters; i++) {
//   var letters = readline.question("Please enter a letter: ");
//   reverse.push(letters);
// }
