...
// var password = "pizza";
// var guess = readline.question("What's the password: ");
// while (guess != password) {
//   console.log("That's not the right password. Try again.")
//   guess = readline.question("Please enter a number: ");
// }
// console.log("You got the password. Nice!")
...
// var add = 0;
// while (sum < 100) {
//   guess = parseInt(readline.question("Please enter a number: "));
//   sum += guess;
// }
// console.log("Your sum is now more than 100.");
