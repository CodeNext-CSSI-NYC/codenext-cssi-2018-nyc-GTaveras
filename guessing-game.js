...
// var tries = 1;
// var guess = parseInt(readline.question("Guess a number 1 to 100: "));
// while (guess != randomNum) {
//   console.log("Your number was not correct. Try again.");
//   guess = parseInt(readline.question("Guess again: "));
//   tries++;
// }
// console.log("You guesses correctly! It took you " + tries + " times to guess the number.");