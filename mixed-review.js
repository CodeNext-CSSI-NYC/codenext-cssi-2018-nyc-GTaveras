...
function countMoney(coins) {
  ...
  //quarters
  total += parseInt(coins["quarters"] * 25);
  //dimes
  total += parseInt(coins["dimes"] * 10);
  //nickels
  total += parseInt(coins["nickels"] * 5);
  //pennies
  total += parseInt(coins["pennies"] * 1);
...
function waitFor24() {
  var is24 = readline.question("Please enter a number: ");
  while (is24 != 24) {
    is24 = readline.question("Please enter a number: ");
  }
}
